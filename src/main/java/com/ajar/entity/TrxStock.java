...
public class TrxStock {
    ...
    public String toString() {
        return "TrxStock{" + "ticklerID=" + ticklerID + ", ticklerDT=" + ticklerDT + ", ticklerOpen=" + ticklerOpen + ", ticklerHigh=" + ticklerHigh + ", ticklerLow=" + ticklerLow + ", ticklerClose=" + ticklerClose + ", ticklerVol=" + ticklerVol + '}';
    }
