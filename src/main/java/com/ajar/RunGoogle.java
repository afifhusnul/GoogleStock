...
// Read data from DB
        ...
        for (Iterator it = list.iterator(); it.hasNext();) {            
            ...
            GregorianCalendar start = new GregorianCalendar(2016, 2, 14);
            GregorianCalendar end = new GregorianCalendar(2016, 2, 15);
            GoogleStockDownloader test = new GoogleStockDownloader(t.getTicklerID(), start, end);
